...
def main():
    ...
    clima_semanal.ingresar_temperaturas_semanales(temperaturas_semanales)
    promedio_semanal_semanal = clima_semanal.calcular_promedio_semanal()
    print(f"El promedio de temperaturas de la semana (ClimaSemanal) es: {promedio_semanal_semanal}")
